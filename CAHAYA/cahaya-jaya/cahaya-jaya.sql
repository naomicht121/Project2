...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2019 at 04:37 AM
...
(1, 'farhan', 'farhan', 'Farhan Maulana', 'farhanmaulana88@gmail.com', 'Jl.Pasir Impun, Gg Haji Mulya No.54 RT.03 RW.12', 'Bandung', '081321319954', '73648102951', 1650002, 'farhan.jpg', '2'),
...
(8, 1, 1, 'Nasi Tim', ' DRESS if the Blouse only consists of superiors, while the dres consist of united superiors and subordinates. The word dress comes from English which means dress.', 150000, 7, '4388824s1280h960.jpg'),
(10, 1, 1, 'Bala-bala', 'BLAZER is a kind of jacket that is worn as casual clothing but still looks pretty neat. Blazer shaped like a suit with more relaxed pieces.', 200000, 7, '5216111s1280h960.jpg'),
(11, 1, 1, 'Nasi Goreng', 'PANTSUIT is a blazer-shaped top with matching pants or skirts that are made from the same. You can choose these clothes to attend office events, which are not required to wear uniforms, or meet clients for example at dinner hours. Sometimes you also need this clothes for friends to apply for work. Pantsuit has also become a trend after Hillary Clinton \'popularized\' this fashion item during the campaign.', 450000, 5, 'mie-goreng-saus-tiram.jpg'),
(14, 4, 2, 'Siomay', 'Siomay adalah makanan hasil dari olahan ikan yang sangat enak.', 3300000, 5, '5216271s1280h960.jpg'),
(15, 4, 2, 'Batagor', 'Chipset: Mediatek MT6771 Helio P60 (12 nm) RAM & Memori: 6 GB & 64 GB Kamera: Dual 16 MP + 2 MP Baterai: Li-Po 3500 mAh ', 4999999, 3, 'batagor-paling-enak-d-kebutuhan-rumah-tangga-makanan-14514853.jpg'),
(16, 4, 2, 'Batagor Kuah', 'Berlayar 5.99', 2799999, 3, '37501fa5-fdc7-44cb-a929-cd7ec1faa1e8.jpeg'),
...
(20, 3, 4, 'Jus Alpukat', 'Shimmering Skin Perfector', 200000, 10, 'ua438bffd7833a20a6ecd04cccf9162ce-1_1510228809395.jpg'),
...
--
ALTER TABLE `categories`
  MODIFY `categori_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `topup`
  MODIFY `topup_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
COMMIT;
