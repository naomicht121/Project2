  ...
  <tbody>
    ...
    <form action="<?php echo base_url('seller/home_seller/shipping_status')?>" method="post">
      ...
      <?php }elseif($key['shipping_status'] == 'Already Received') { ?>
       <button type="submit" class="btn btn-sm btn-success" disabled>Success</button>
      <?php }else{ ?>
      <button type="submit" onclick="return validasi3();" class="btn btn-sm btn-success">Update</button>
      <?php } ?>
